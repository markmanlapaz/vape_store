<?php
/**
 * WooCommerce product card template (used in loops).
 *
...
<li <?php wc_product_class( 'fs-product-card', $product ); ?> data-product-id="<?php echo esc_attr( $product->get_id() ); ?>">
	...
	<div class="fs-product-card__image">
		...
		<div class="fs-product-card__actions">
			...
			<button class="fs-product-card__action fs-wishlist-btn" data-product-id="<?php echo esc_attr( $product->get_id() ); ?>" aria-label="<?php esc_attr_e( 'Add to Wishlist', 'flavor-starter' ); ?>" title="<?php esc_attr_e( 'Wishlist', 'flavor-starter' ); ?>">
	...
	<div class="fs-product-card__body">
		...
		if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) : ?>
			<a href="<?php echo esc_url( get_term_link( $terms[0] ) ); ?>" class="fs-product-card__cat">
		...
		<div class="fs-product-card__footer">
			...
			<?php elseif ( ! $product->is_in_stock() ) : ?>
				<span class="fs-product-card__out-of-stock"><?php esc_html_e( 'Sold Out', 'flavor-starter' ); ?></span>
			<?php else : ?>
